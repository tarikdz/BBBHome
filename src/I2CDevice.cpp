...
int I2CDevice::writeByteArray(char *byteArray, int byteLength){

	if(::write(this->file,byteArray,byteLength)!=byteLength){
		perror("I2C: Failed to write Byte Array to the device\n");
	    return 1;
	}
